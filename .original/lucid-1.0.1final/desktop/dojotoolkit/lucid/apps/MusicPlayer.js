dojo.provide("lucid.apps.MusicPlayer");

dojo.declare("lucid.apps.MusicPlayer", lucid.apps._App, {
	init: function(args){
		...
		var nls = this.nls = dojo.i18n.getLocalization("lucid", "common");
	...
	openFile: function(file){
		if (file){
			this.sound = new lucid.Sound({
				src: lucid.filesystem.embed(file)
			});
			this.play();
			file = file.split("/");
