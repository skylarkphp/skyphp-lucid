...
define([
  ...
  "dojo/on",
  "dojox/css3/transit", 
  "qfacex/dijit/primitives/dom/Animation"                        
],function(Object,Class,topic,Window,on,transit,anim) {

	var FormWindow = Class.declare({
		"-parent-"		:	Window,
		...
		"-protected-"	:	{
			...
			"handlers"	:	{
				...
				_doStartTransition: function(evt){
					...
					this.transition(target, Object.mixin({reverse: false},evt.detail));
		...
		"-public-"	:	{
			...
			"-methods-"	:	{
				 ...
				 *@method 
				 */
				"transition": function(/*Control*/form,/*Object*/opts){
					//summary: 
					//  
					...
					if (next!==current){
						...
						topic.publish("/openstar/desktop2/deprecated/jaml/Window/transition", [next, toId]);
