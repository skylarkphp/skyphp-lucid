...
define([
...
],function(dojo,lang,domStyle,on,topic,Deferred,Dialog,ContentPane,SplitContainer,TextBox,Button,FilteringSelect,Toolbar,Menu,MenuItem,Window,FloatingPane,nlsCommon) {
	var  dialog = {};
	...
	dojo.mixin(dialog , {
		...
		inputTest: function(/*_inputArgs*/object)
		{
			//	summary:
			//		A dialog with a text field
			//	example:
