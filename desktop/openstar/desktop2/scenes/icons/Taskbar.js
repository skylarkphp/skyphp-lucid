...
//	            dijit.byId(store.getValue(item, "id"))._menu.bindDomNode(domNode);
	    ...
	    setupLaunchApp: function(){
	        this._onLaunch = topic.subscribe("/openstar/desktop2/launchApp", lang.hitch(this, function(scene,sysname,name){
		        	if (this.scene !== scene) {
		        		return;
		        	};
		            ...
		            var onEnd = topic.subscribe("/openstar/desktop2/launchAppEnd",function(){
