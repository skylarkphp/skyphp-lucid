...
if(!dojo._hasResource["openstar.apps.KatanaIDE._codeTextArea.plugins.MatchingBrackets"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["openstar.apps.KatanaIDE._codeTextArea.plugins.MatchingBrackets"] = true;
dojo.provide("openstar.apps.KatanaIDE._codeTextArea.plugins.MatchingBrackets");

openstar.apps.KatanaIDE._codeTextArea.plugins.MatchingBrackets.startup = function(args){
