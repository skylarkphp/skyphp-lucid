...
if(!dojo._hasResource["openstar.apps.KatanaIDE._codeTextArea.plugins.GoToLineDialog"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["openstar.apps.KatanaIDE._codeTextArea.plugins.GoToLineDialog"] = true;
dojo.provide("openstar.apps.KatanaIDE._codeTextArea.plugins.GoToLineDialog");
dojo.require("dijit.Dialog");

openstar.apps.KatanaIDE._codeTextArea.plugins.GoToLineDialog.startup = function(args){
