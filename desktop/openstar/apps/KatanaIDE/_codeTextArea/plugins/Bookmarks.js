...
if(!dojo._hasResource["openstar.apps.KatanaIDE._codeTextArea.plugins.Bookmarks"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["openstar.apps.KatanaIDE._codeTextArea.plugins.Bookmarks"] = true;
dojo.provide("openstar.apps.KatanaIDE._codeTextArea.plugins.Bookmarks");
dojo.require("dijit.Menu");
dojo.require("dijit.Dialog");

openstar.apps.KatanaIDE._codeTextArea.plugins.Bookmarks.startup = function(args){
	var targetLine = 0;
	var targetBookmark = {};
	var bookmarks = [];
