...
],function(dojo,require,_WidgetBase,_TemplatedMixin,_WidgetsInTemplateMixin,Runtime,_App,Window,Workbench,filesystem,nlsCommon,nlsApps,nlsMessages,tplQfaceIDE) {
...
//		}
	...
	require({
				async: false,
				paths:{
					"davinci": davinciLibPath+"/davinci",
					"preview": davinciLibPath+"/preview",
					"system" :  davinciLibPath+"/system",
					"metadata" :  davinciLibPath+"/metadata",
					"orion" :  davinciLibPath+"/orion",
					"orionplugin" :  davinciLibPath+"/orionplugin",
					"static" :  davinciLibPath+"/static"
				}
			},[
				"qfacex/studio/plugins/ide/Registry",
				"dojo/i18n!qfacex/studio/plugins/ide/nls/webContent"
				
			],function(DvRegistry,nlsQfaceIDE) {
				runWorkbench = function(workbench) {
				/*
					var userInfo;
				...
				*/
				...
				//dvRegistry.init();
				//DvRuntime.initialPerspective="davinci.ve.pageDesign";
	...
	var  QfaceIDE =  dojo.declare("openstar.apps.QfaceIDE", _App, {
