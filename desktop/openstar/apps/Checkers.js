define([
...
],function(Class,array, declare, lang, dojo,i18n,_FormValueWidget,Button,TextBox,Toolbar,gfx,Moveable,_App,Window,StatusBar,filesystem,dialog,nlsCommon,nlsApps,nlsMessages) {
	...
	return Class.declare({
		...
		"-public-"	:	{
			...
			"-methods-"	:	{
				init: function(args){
					var app = nlsApps;//dojo.i18n.getLocalization("desktop", "apps",this.lang);
					this.win = new Window({
			        	app  : this,
						title: app["Checkers"],
						width: "400px",
...
return declare("openstar.apps.Checkers", _App, {
});
