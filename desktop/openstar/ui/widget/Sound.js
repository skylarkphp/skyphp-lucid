...
define([
...
],function(array, declare, lang, kernel) {
	dojo.declare("scene.Sound", dijit._Widget, {
		//	summary:
	...
	dojo.declare("scene.Sound._backend", null, {
		//	summary:
		//		The base sound backend class
		//		Most of these properties are repeated in scene.Sound, see that for more info
		id: "",
		//	domNode: domNode
	...
	dojo.declare("scene.Sound.html", scene.Sound._backend, {
		//	summary:
		//		Sound backend for the HTML5 audio tag
		//		See scene.Sound._backend for more info
		htmlSound: null,
		capabilities: {
			play: true,
			pause: true,
	...
	dojo.declare("scene.Sound.flash", scene.Sound._backend, {
		//	summary:
	...
	dojo.declare("scene.Sound.embed", scene.Sound._backend, {
		//	summary:
