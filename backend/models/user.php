...
mlog("SET".$_SESSION['userid']);
		...
		function make_userdir()
		{
			...
			if(!is_dir($GLOBALS['path']."/../files/".$blah)){
				...
				mkdir($GLOBALS['path']."/../files/".$blah."/Desktop/life");
				mkdir($GLOBALS['path']."/../files/".$blah."/Desktop/study");
				mkdir($GLOBALS['path']."/../files/".$blah."/Desktop/work");
				$ourFileName = $GLOBALS['path']."/../files/".$blah."/Desktop/life/welcome.txt";
